"""
WebSeeker API Server for n8n Integration
...
def run_scan(scan_id, target_url):
    ...
    try:
        ...
        # Limit endpoints to scan (Increased for accuracy in Enterprise mode)
        endpoints_to_scan = discovered_urls[:200]  # Scans top 200 endpoints
...
def format_report_for_n8n(results):
    ...
    report = []
    report.append("=" * 60)
    report.append("[SECURITY] WEBSEEKER SECURITY SCAN REPORT")
    report.append("=" * 60)
    report.append(f"")
    ...
    report.append("=" * 60)
    report.append("Report generated by WebSeeker")
    report.append("=" * 60)
...
if __name__ == '__main__':
    print("=" * 60)
    print("       WEBSEEKER API SERVER FOR n8n")
    print("=" * 60)
